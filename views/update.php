...
function validateForm() {
  var x = document.forms["myForm"]["f1"].value;
  var y = document.forms["myForm"]["l1"].value;
  var z = document.forms["myForm"]["m"].value;
  var w = document.forms["myForm"]["e"].value;
  var l = document.forms["myForm"]["p"].value;
  var m = document.forms["myForm"]["pc"].value;

  if ((x == "" || x == null)&&(y=="" || y==null)&&(z=="" || z==null))&&(w=="" || w==null)&&(l=="" || l==null)&&(m=="" || m==null) {
...
<body class="bg-gradient-primary">
    ...
    <div class="col-lg-6 d-none d-lg-block bg-login-image"></div>
        ...
        <form class="form-horizontal" onsubmit="return validateForm()" method="post" role="form" name="myForm" required>
